        ...
        <div className="hero--section--content--box">
          <div className="hero--section--conten">
            ...
            <p className="hero--section--description">
              I’m, a passionate and enthusiastic student developer with a strong
              grip on backend technologies like Node.js, Express.js, and Spring.
              My dedication to these technologies enables me to deliver scalable
              applications.
              <br />
              <br /> Beyond backend development, I am an avid competitive
              programmer and LeetCode enthusiast. Solving complex problems on
              LeetCode keeps me sharp and helps me bring innovative solutions to
              ...
              <div className="hero--section--links--box hidden-left">
                <div className="hero--section--links">
                  <svg
                    onClick={() =>
                      openLink(
                        "https://www.linkedin.com/in/prasu-hirpara-130575247/"
                      )
                    }
                ...
                <div className="hero--section--links">
                  <svg
                    onClick={() => openLink("https://github.com/PrasuHirapara")}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                ...
                <div className="hero--section--links">
                  <svg
                    onClick={() =>
                      openLink("https://leetcode.com/u/PrasuHirpara/")
                    }
                    fill="#000000"
                    width="180px"
                    height="180px"
                ...
                <div className="hero--section--links">
                  <svg
                    onClick={() =>
                      openLink(
                        "https://www.instagram.com/prasu_hirpara?igsh=MTJudnJ6cDZsa3Fndg=="
                      )
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
